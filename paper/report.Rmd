...
From the initial 8659 users we have arrived lately at 12526 users. It is not believable, however, to claim that this Big Bang of free software developers in Spain is singly due do this ranking, or some co-occurring event. In fact, it might be due to several different reasons.
...
At any rate, it is quite clear that the ranks of new users increase mainly *not* due to *really* new users, that is, persons newly signing up and using GitHub.
